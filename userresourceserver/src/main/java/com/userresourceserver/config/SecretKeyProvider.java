package com.userresourceserver.config;
...
public class SecretKeyProvider {
	...
	public String getKey1() throws URISyntaxException, KeyStoreException, IOException, NoSuchAlgorithmException,
			CertificateException, UnrecoverableKeyException {
		return new String(getKeyPair().getPublic().toString());
	}
